...
public class SignatureConst {
	...
	public static final String prod_id = "NSE";

	public static final int port_no = 443;

	public static final String ReqHashKey = "KEY123657234";

	public static final String RespHashKey = "KEYRESP123657234";
	public static final String txncurr = "INR";
